...
{
	/// <summary>
	/// Description of solera_5_16.
	/// </summary>
	public partial class solera_5_16 : Form
	{
		...
		{
			double neto,peso,iva,precio, medida,medida2,medida3,medida4,medida5,medida6,medida7,medida8,medida9, mtr;
        	//decimal dec1;
        	neto=0.0;
			peso=0.0;
			iva=0.0;
        	...
        	else if(rd2_1_2.Checked)
			{
				...
				iva=precio*.16;
				neto=precio+iva;
				System.Windows.Forms.MessageBox.Show("Precio total:  $" + neto.ToString());
			}
        	else if(rd3.Checked)
			{
				peso=medida6*mtr;
