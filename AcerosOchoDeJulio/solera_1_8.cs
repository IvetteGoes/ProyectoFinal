...
{
	/// <summary>
	/// Description of solera_1_8.
	/// </summary>
	public partial class solera_1_8 : Form
	{
		...
		{
			double neto,peso,iva,precio, medida,medida2,medida3,medida4,medida5,medida6, mtr;
        	//decimal dec1;
        	neto=0.0;
			peso=0.0;
			iva=0.0;
		...
		void RichTextPresupuestoTextChanged(object sender, EventArgs e)
		{
