...
{
	/// <summary>
	/// Description of redondos.
	/// </summary>
	public partial class redondos : Form
	{
		...
		{
			double neto,peso,iva,precio, medida,medida2,medida3,medida4,medida5,medida6,medida7,medida8,
                   	medida9, medida10, mtr;
        	//decimal dec1;
        	neto=0.0;
			peso=0.0;
			iva=0.0;
